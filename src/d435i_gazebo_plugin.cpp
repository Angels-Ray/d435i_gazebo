...
namespace gazebo
{
  ...
  {
    ROS_INFO("=== D435i Gazebo plugin Load() called ===");
  ...
  void D435iGazeboPlugin::GenerateAlignedDepthToColor()
  {
    ...
    // For simulation, we use the same depth data but with color camera parameters
    // In real hardware, this would involve complex reprojection
